...
export default function ChaleAOrigemClient() {
  const [selectedImage, setSelectedImage] = useState(0)
  const [showAllPhotos, setShowAllPhotos] = useState(false)
  const [hostexLoaded, setHostexLoaded] = useState(false)
  const [hostexFailed, setHostexFailed] = useState(false)
                        ...
                        >
                          <div className="text-center">
                            ...
                            <button
                              ...
                              className="rounded-full bg-gold-300 px-6 py-2 font-medium text-teal-900 transition-colors hover:bg-gold-400"
                            >
